...
public class MultiThreadFileDownloadClient2 {
    ...
    private static void downloadFile(String DOWNLOAD_URL1,String FILE_NAME1,String SAVE_PATH1,int THREAD_COUNT1) throws IOException, InterruptedException, ExecutionException {
